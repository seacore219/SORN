...
def organize_simulation_results(batch_folder, num_sims, root_dir):
    ...
    moved_count = 0
    test_single_dir = os.path.join(backup_dir, "test_single_original")
...
def run_parallel_simulations(num_sims=8, num_processes=None, show_output=True, 
                           organize_results=True, param_file="param_ExtraInputNew.py"):
    """
    ...
    Parameters:
        ...
        param_file: Name of parameter file (default: param_ExtraInputNew.py)
    """
    # Get paths
...
def main():
    ...
    parser.add_argument('--param-file', type=str, default='param_ExtraInputNew.py',
                        help='Parameter file name (default: param_ExtraInputNew.py)')
